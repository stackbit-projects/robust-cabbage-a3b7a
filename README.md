...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/5fda3b7ade47dc0016f2e0c9
...
To start editing your site, you can use the Sanity interface at https://robust-cabbage-a3b7a.sanity.studio/.
...
Generated at `2020-12-16T16:56:16.797Z` by Stackbit version `0.3.40`.